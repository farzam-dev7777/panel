class MatterIntake < ApplicationRecord
  ...
  validates_presence_of :submitter_name, :name_of_matter_client, :matter_type_id, :matter_description, :following_matter_involve,
    :bmo_lawyer_name, :lob_contact_for_po, :cost_centre_for_legal_fees, :business_paying_for_matter, :jurisdiction, :paying_entity, :outside_counsel_engaged, :is_syndicate_matter,
  ...
  validates_presence_of :bmo_lawyer_name, :legal_group_of_bmo_lawyer, :work_area, :work_area_type, :is_syndicate_matter,
    ...
    :business_paying_for_matter, :jurisdiction, :outside_counsel_engaged,
  ...
  def self.ransackable_attributes(auth_object = nil)
    ["additional_comments_for_lrc_lawyer", "additional_matter_contact", "afa_details", "allegation_of_employee_misconduct", "amount_claimed_1_currency", "amount_claimed_2_currency", "amount_claimed_by_bmo", "amount_claimed_by_bmo_currency", "amount_claimed_from_bmo_1", "amount_claimed_from_bmo_2", "applicable_technical_specialty_data", "applicable_technical_specialty_data_type", "arbitration_accepted", "arbitration_offered", "asset", "bmo_lawyer_name", "bmo_party", "branch", "branch_manager_investment_advisor", "breakdown_of_claim_amount", "budget_amount", "business_activity_level_1", "business_activity_level_2", "business_paying_for_matter", "can_reimbursed_matter", "case_caption", "comset_issues", "comset_ref", "cost_centre_for_legal_fees", "court_name", "court_type", "created_at", "date_suit_filed", "deal_code", "docket_number", "email_notification_to_litigation_specialist_team", "event_type_level_1", "event_type_level_2", "firm_type", "following_matter_involve", "form_type", "group_paying_for_matter", "id", "is_alternative_fee_arrangement", "is_conceal_imanage_workspace", "is_ore_reportable", "is_otherwise_reportable", "is_paper_file", "is_syndicate_matter", "jurisdiction", "key_facts", "law_firm_id", "lawyer_id", "lawyer_reviewed_at", "legal_analysis", "legal_group_of_bmo_lawyer", "lob_contact_for_po", "lob_contact_name", "lob_submitted_at", "lxp_id", "lxp_reviewed_at", "matter_description", "matter_number", "matter_type_id", "mi_matter", "mode_of_payment", "name_of_matter_client", "name_of_non_panel_firm", "name_of_panel_firm", "nature_of_events", "opposing_counsel_firm", "other_matter_issues", "other_party", "outside_counsel_engaged", "paying_entity", "primary_issue", "process_type_level_1", "process_type_level_2", "product_type_level_1", "product_type_level_2", "receive_general_business_data", "receive_general_business_data_type", "receive_personal_information", "receive_personal_information_data_type", "region_name", "secondary_issue", "stage_of_litigation", "status", "submitter_name", "type_of_price", "unquantified_claim", "updated_at", "user_id", "valued_at", "who_requires_access_to_imanage_workspace", "work_area", "work_area_type", "written_legal_notice_required"]
  end
