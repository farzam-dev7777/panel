class MatterIntake < ApplicationRecord
  ...
  MANDATORY_FIELDS = [:matter_description, :submitter_name, :name_of_matter_client, :matter_number, :requested_by_id, :matter_type_id, :line_of_business_id]
  ...
  def show_status
    if deleted_at.present?
      ...
      "Open"
    elsif matter_approvals.where(status: ['rejected']).present?
      'Rejected'
    else
