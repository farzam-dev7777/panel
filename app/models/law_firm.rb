class LawFirm < ApplicationRecord
  ...
  def self.ransackable_attributes(auth_object = nil)
    ["action_plan_findings", "action_plan_status", "allow_to_create_matters", "billing_contact_email", "billing_contact_name", "bmo_relationship_partner_email", "bmo_relationship_partner_name", "bmo_relationship_partner_phone_number", "created_at", "document", "engagement_number", "id", "information_security_assessment_outcome", "information_security_class", "information_security_contact", "information_security_contact_email", "initial_date_of_engagement_with_the_bank", "law_firm_id", "relationship_number", "secondary_rm_contact", "secondary_rm_contact_email", "status", "tenant_id", "type_of_matters_your_law_firm_handles_for_us", "updated_at"]
  end

  def self.ransackable_associations(auth_object = nil)
    ["law_firms_tenants", "action_items", "activity_logs", "conflict_waivers", "countries", "exception_requests", "external_lawyers", "feedbacks", "form_submissions", "history_submissions", "internal_notes", "issues", "jurisdiction_types", "jurisdictions", "law_firm_attachments", "law_firms_countries", "law_firms_jurisdiction_types", "law_firms_matter_types", "law_firms_states", "law_firms_sub_matter_types", "law_firms_tenants", "locations", "matter_intakes", "matter_types", "panel_request", "requests", "states", "sub_matter_types", "tenants", "todo_tasks", "user", "users", "values"]
  end
