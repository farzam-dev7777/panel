class Admin::CommentsController < Admin::BaseController
  ...
  def create
    ...
    ActiveRecord::Base.transaction do
      ...
      if @comment.save
        redirect_back fallback_location: admin_root_path, notice: "comment Added"
      else
       # flash.now[:alert] = @comment.errors.full_messages.join(', ')
        redirect_back fallback_location: admin_root_path, alert: @comment.errors.full_messages.join(', ')
      end
    end
  end
