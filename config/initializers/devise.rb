...
OKTA_SETUP = lambda do |env|
  ...
  env['omniauth.strategy'].options[:client_options] = {
    site:          site,
    authorize_url: "#{site}/oauth2/default/v1/authorize",
...
AZURE_SETUP = lambda do |env|
  ...
  env['omniauth.strategy'].options['token_params'] = {:redirect_uri => 'https://lb.preseal.ca/users/auth/azure_activedirectory_v2/callback'}
end
...
Devise.setup do |config|
  ...
  # config.pepper = 'e3ea4885f8f2f2ff1a8c8e6a9873df4ed007bd578bb81438f1d577b9810a1f5219ecd271517c12764db9cd1181040b013d241d53010f0cdafd244413ee607b18'
  ...
  config.reset_password_keys = [:email, :username]
