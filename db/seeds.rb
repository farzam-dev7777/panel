...
# law_firm.log_activity('account_created', true)
# law_firm = LawFirm.create!(name: "E&A Law Firm - Toronto Family Law Attorney",description: "Child Support Lawyers",email: "ealawfirm@seal-test.com",phone: "+1 416 777 2216", temp_password: 'se123456al')
# law_firm.log_activity('account_created', true)
# law_firm = LawFirm.create!(name: "Shulman Law Firm",description: "Family Law Attorney",email: "shulmanlawfirm@seal-test.com",phone: "+1 416 661 2777", temp_password: 'se123456al')
# law_firm.log_activity('account_created', true)
# law_firm = LawFirm.create!(name: "Kahler Personal Injury Law Firm",description: "Personal Injury Attorney",email: "kahlerlawfirm@seal-test.com",phone: "+1 888-608-2111", temp_password: 'se123456al')
# law_firm.log_activity('account_created', true)
# law_firm = LawFirm.create!(name: "Worsoff Law Firm",description: "",email: "worsofflawfirm@seal-test.com",phone: "+1 (416) 423-3333", temp_password: 'se123456al')
# law_firm.log_activity('account_created', true)
# law_firm = LawFirm.create!(name: "Borders Law Firm Immigration Lawyers",description: "Immigration Attorney",email: "borderslaw_firm@seal-test.com",phone: "+1 (416) 481-5689", temp_password: 'se123456al')
# law_firm.log_activity('account_created', true)
# law_firm = LawFirm.create!(name: "Wires Law",description: "Attorney",email: "wireslawfirm@seal-test.com",phone: "+1 (416) 549-5922", temp_password: 'se123456al')
# law_firm.log_activity('account_created', true)
# law_firm = LawFirm.create!(name: "The Law Firm of Ted Yoannou",description: "Criminal Justice Attorney",email: "tedyoannoulawfirm@seal-test.com",phone: "+1 (416) 650-1011", temp_password: 'se123456al')
# law_firm.log_activity('account_created', true)
# law_firm = LawFirm.create!(name: "Kruse Law",description: "Criminal Justice Attorney",email: "kruselawfirm@seal-test.com",phone: "+1 (416) 900-3889", temp_password: 'se123456al')
# law_firm.log_activity('account_created', true)
