...
ActiveRecord::Schema[7.0].define(version: 2023_01_31_195735) do
  ...
  create_table "tenant_admin_users", id: :serial, force: :cascade do |t|
    t.string "email", default: "", null: false
    ...
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
    t.index ["email"], name: "index_tenant_admin_users_on_email", unique: true
    t.index ["reset_password_token"], name: "index_tenant_admin_users_on_reset_password_token", unique: true
    t.index ["username"], name: "index_tenant_admin_users_on_username", unique: true
  end
